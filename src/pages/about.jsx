        ...
        <div className="min-h-screen bg-white flex flex-col font-sans selection:bg-indigo-100 overflow-x-hidden">
            ...
            <main className="flex-1">
                ...
                <section className="py-24 px-6 max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">Di Balik Layar</h2>
                        <div className="h-1.5 w-20 bg-indigo-600 mx-auto rounded-full mb-6" />
                        <p className="text-slate-500 font-medium text-lg">Tim kreatif yang membangun SiberAman dengan semangat kolaborasi.</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                        {teamMembers.map((member, index) => (
                            <motion.div 
                                ...
                                className="group"
                            >
                                <div className={`aspect-[4/5] rounded-[2.5rem] overflow-hidden mb-8 relative shadow-2xl shadow-slate-200 ${member.color}`}>
                                    <img
                                        src={member.image}
                                        alt={member.name}
                                ...
                                <div className="px-2">
                                    ...
                                    <p className="text-indigo-600 font-bold text-xs uppercase tracking-[0.2em] mb-4">{member.role}</p>
                ...
                >
                    ...
                    <div className="max-w-3xl mx-auto relative z-10">
                        ...
                        <h2 className="text-3xl sm:text-5xl font-bold text-white mb-6">Keamanan Anda Prioritas Kami</h2>
